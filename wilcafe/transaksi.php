  ...
  <div class="row">
    <div class="col-5">
      <div class="card border-warning shadow-lg mb-3">
        <div class="card-header bg-transparent border-warning text-warning"><b>ANGKRINGAN PAKDHE JEMANG</b></div>
        <div class="card-body">
        ...
        <div class="card-footer bg-transparent border-warning text-black">
    ...
    <div class="col-7">
      <div class="card border-warning mb-3">
        <div class="card-header bg-transparent border-warning">No. Invoice - <span id="noTransaksiBaru"></span> </div>
