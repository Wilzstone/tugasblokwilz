...
if ($jabatan == "Admin") { ?>
  <div class="row mt-5 pt-3">
    <div class="col-md-7 jumbotron m-5">
      <h1 class="display-5">Coffee Wilz</h1>
      <p class="lead text-warning">Kualitas Khan Maen Rasanya</p>
      <hr class="hr" style="width:100%; margin-top: -10px">
      <p class="smk">wilzstone</p>
    </div>
  </div>
<?php
}
    ...
    <div class="col-xl-3 col-md-6 mb-2">
      <div class="card border-left-warning shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="font-weight-bold text-warning text-uppercase mb-1">Laki-laki
              </div>
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="font-weight-bold text-warning text-uppercase mb-1">
                Ttl Penerimaan</div>
              <div class="h5 mb-0 font-weight-bold text-grey-800"><?= number_format($ttlKsr); ?> </div>
            </div>
            <div class="col-auto">
              <i class="fa fa-gift fa-2x text-gray-300"></i>
            </div>
      ...
      <div class="card border-left-warning shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            ...
            <div class="col-auto">
              <i class="fa fa-credit-card fa-2x text-warning-300"></i>
            </div>
          </div>
        </div>
      </div>
